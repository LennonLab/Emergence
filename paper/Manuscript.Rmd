...
*Autocorrelated residence times and right-skewed residence time distributions——*As expected, residence times of individuals, resource particles, inert tracers, and most any non-permanent component of the system were highly correlated. Right-skewed distributions characterized the life history of individuals, the presence of resource particles, and the tenure of species and traits (Figure ?). Residence time distributions were generally well approximated by lognormal and power-law models (e.g. Pareto, Zipf, Zipf-Mandelbrot).
