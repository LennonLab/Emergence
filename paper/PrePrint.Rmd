...
**Source code**--To save space, we also refer the reader to the README.md file on the public simplex GitHub.com repository (https://github.com/LennonLab/simplex/blob/master/README.md) for descriptions of source code files and directories.
...
ODD stands for Overview, Design concepts, and Details. Here, we descibe simplex *largely* according to the ODD protocol.
...
We thank Mario Muscarella and Xiao Xiao for fruitful discussions. **Grant number?**
