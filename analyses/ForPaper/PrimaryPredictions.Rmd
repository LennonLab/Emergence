...
```{r, results = 'hide', echo=FALSE, message = FALSE, warning = FALSE, fig.width=7, fig.height=4}
png(filename = '~/GitHub/hydrobide/results/figs/ForPaper/NandS_vs_ResTime_ByMotion.png',
    width = 1500, height = 1200, res=200, bg = "white")
...
```{r, results = 'hide', echo=FALSE, message = FALSE, warning = FALSE, fig.width=7, fig.height=4}
png(filename = '~/GitHub/hydrobide/results/figs/ForPaper/EvennessAndTurnover_vs_ResTime.png',
      width = 1500, height = 1200, res=200, bg = "white")
...
png(filename = '~/GitHub/hydrobide/results/figs/ForPaper/Diversity_vs_N.png',
      width = 1500, height = 1200, res=200, bg = "white")
...
png(filename = '~/GitHub/hydrobide/results/figs/ForPaper/Diversity_vs_N2.png',
      width = 1500, height = 1200, res=200, bg = "white")
...
png(filename = '~/GitHub/hydrobide/results/figs/ForPaper/Diversity_vs_N_ByMotion.png',
      width = 1500, height = 1200, res=200, bg = "white")
