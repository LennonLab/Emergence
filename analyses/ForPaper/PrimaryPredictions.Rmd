...
p1 <- ggplot()+
  ...
  scale_colour_manual(values = c("navy", "darkgreen"),
      labels = c(paste("Fluid, r^2 = ",round(f.N.2.r2,2)),
      paste("Non-fluid, r^2 = ",round(r.N.2.r2,2))),
      name = "") +
...
p2 <- ggplot()+
  ...
  scale_colour_manual(values = c("navy", "darkgreen"),
      labels = c(paste("Fluid, r^2 = ",round(f.S.2.r2,2)),
      paste("Non-fluid, r^2 = ",round(r.S.2.r2,2))),
      name = "") +
...
p1 <- ggplot()+
  ...
  scale_colour_manual(values = c("navy", "darkgreen"),
      labels = c(paste("Fluid, r^2 = ",round(f.ev.2.r2,2)),
      paste("Non-fluid, r^2 = ",round(r.ev.2.r2,2))),
      name = "") +
...
p2 <- ggplot()+
  ...
  scale_colour_manual(values = c("navy", "darkgreen"),
      labels = c(paste("Fluid, r^2 = ",round(f.to.2.r2,2)),
      paste("Non-fluid, r^2 = ",round(r.to.2.r2,2))),
      name = "") +
