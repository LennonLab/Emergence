...
plot(log(N), E, xlab="Total abundance", 
     ylab="Species Evenness", 
     main = "Evenness vs. N",
     col='lightseagreen')
...
growth <- sim.data$AvgPerCapita_GrowthRate
plot(m.tau, log(growth), xlab="Cell Residence Time", 
     ylab="growth", 
     main = "Per capita growth vs. Tau",
     col='dodgerblue')

maint <- sim.data$AvgPerCapita_Maintenance
plot(m.tau, SimpD, xlab="Cell Residence Time", 
     ylab="maintenance", 
     main = "Per capita maintenance vs. Tau",
     col='darkolivegreen')

immigration <- sim.data$Immigration_Rate
