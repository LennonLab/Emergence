...
There four basic types of SARs and for general sampling schemes (Rosensweig 2000).
Here, we consider SARs that are generated by the random aggregation of subplots belonging to a single biota (i.e., not crossing ecoregions or biogeographical provinces).
